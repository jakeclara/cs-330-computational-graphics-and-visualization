...
public:
	...
	void ApplyShaderColor(
		float redColorValue,
		float greenColorValue,
		float blueColorValue,
		float alphaValue);

	void ApplyShaderTexture(std::string textureTag);
	void ApplyTextureUVScale(float u, float v);
	void ApplyShaderMaterial(std::string materialTag);
